...
print(Fore.MAGENTA + '		 ')
print(Fore.MAGENTA + '		 ')
print(Fore.CYAN + '		       -   by Tappy   -    ' + Fore.RESET)
#if len(sys.argv) > 3:
...
try:
	...
	phone = input('Input number in international format (example: +8333333333) :')
else:
    phone = sys.argv[1]
try:
    sys.argv[2]
	...
	while True:
		filename = input('Username file ? (example: 1.txt or 2.txt)  :')
		try:
